...
def main():
    ...
    sampler = AnnealSampler(denoiser=ad, beta = beta, resample = True,
    ...
    plt.ylabel("Y-axis")
    plt.show()
    plt.savefig("./plots/Anneal_beta_{}_Samples_final_num_particle_{}.png".format(sampler.beta, num_particles))
    ...
    plt.ylabel("Y-axis")
    plt.show()
    plt.savefig("./plots/Anneal_beta_{}_Intermediate_Samples_num_particles_{}.png".format(sampler.beta, num_particles))
